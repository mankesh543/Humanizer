...
function presetOverride(preset) {
  switch (preset) {
    ...
    case "narrative":
      return "Narrative storyteller voice — ORAL storytelling at a dinner table, NOT literary or written prose. Real storytellers interrupt themselves, drift, hedge, and double back; AI detectors flag smooth narrative flow heavily, so this preset DOUBLES DOWN on rhythm and interruption rules. Every paragraph MUST contain: (a) at least two true fragments (2-5 words, no main verb), (b) at least one ultra-short sentence under 4 words, (c) at least one self-correcting aside or hedge ('well, sort of', 'or close to it', 'kind of', 'I think'), (d) at least one register shift where a specific concrete or unexpected word lands inside an otherwise plain sentence. Forbidden as sentence openers: 'Meanwhile', 'Eventually', 'Suddenly', 'Then', 'Finally', 'After that', 'Soon', 'In the end' (use a fragment or specific detail instead). The Step 3 punctuation ban is ABSOLUTE here, including for casual asides — no em-dashes (—), no en-dashes (–), no semicolons, no ' - ' separators anywhere. Use commas, full stops, or sentence breaks instead. Concrete sensory detail is encouraged, but never produce more than two consecutive smooth sentences of similar length. The output should read like someone telling the story out loud, not narrating a novel.";
    case "technical":
